...
public class DetHumh extends AppCompatActivity {
    ...
    private void Fortwsh() {
        String tag_string_req = "req_show_humh";
         pDialog.show();


        JsonArrayRequest jsarRequest = new JsonArrayRequest( AppConfig.URL_HUMH,
...
// Access the RequestQueue through your singleton class.
    ...
    void fillCountryTable(String humh, String timest, String senid) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_edit:
                ...
                Intent remot75 = new Intent(DetHumh.this, LoggedInActivity.class);
            ...
            case R.id.action_about:
                ...
                // as a favorite...
                Intent remot65 = new Intent(DetHumh.this, AboutActivity.class);
