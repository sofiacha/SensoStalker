...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void Fortwsh() {
        ...
        JsonArrayRequest jsarRequest = new JsonArrayRequest( AppConfig.URL_SHOW,
...
// Access the RequestQueue through your singleton class.
    ...
    void fillCountryTable(String avertemp, String day, String hour, String div, String senid) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_edit:
                ...
                Intent remot75 = new Intent(DetailsActivity.this, LoggedInActivity.class);
            ...
            case R.id.action_about:
                ...
                // as a favorite...
                Intent remot65 = new Intent(DetailsActivity.this, AboutActivity.class);
